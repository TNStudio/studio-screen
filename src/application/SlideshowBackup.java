...
*/
public class SlideshowBackup extends Application {
 ...
 Image getNextImage() {
     ...
     try {
         ...
         Logger.getLogger(SlideshowBackup.class.getName()).log(Level.SEVERE, null, ex);
     }
     return null;
 }
 ...
 class ScannerLoader extends Thread implements FileVisitor<Path> {
     ...
     String root = "D:\\Utilisateur\\Dropbox\\Gala2014";
     boolean complete;
     ...
     public void run() {
         ...
         try {
             ...
             Logger.getLogger(SlideshowBackup.class.getName())
